...
typedef struct gmx_repl_ex
{
    ...
    float    zeta;          /* GJS - REDS - 3/10/18 - Actual copy of zeta I will use */

    float    a11;           /* GJS - REDS - 2/14/18 */ // biasing variable coefficient
    float    b11;           /* GJS - REDS - 2/14/18 */ // biasing variable coefficient
    float    c11;           /* GJS - REDS - 2/14/18 */ // biasing variable coefficient
    ...
    float  *Vol;
    float **de;
    float  **biasCoefficients;     /* GJS - REDS - 2/14/18 */

    float *zetas;    /* GJS - REDS - 2/14/18 */

} t_gmx_repl_ex;


static int repl_quantity(struct gmx_repl_ex *re, int ere, float q)
{
    float    *qall;
    int bDiff;
    int      s;
                      ...
                      const ReplicaExchangeParameters &replExParams)
{
    ...
    re->type = -1;
    bTemp    = repl_quantity(re, ereTEMP, re->temp);
...
//    if (MASTER(cr))
    ...
    float vol = 0.0;
        ...
        test_for_replica_exchange(fplog, re, enerd, vol, step);
