...
enum tpxv {
    ...
    /* GJS - REDS - 2-25-2018 */
    tpxv_ReplicaExchangeDynamicalScaling,                    /**< added input parameters a11, b11, and c11 for optimizing zeta */
                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    // GJS - REDS - 3/27/18 - see if this gets rid of the zeroes in my F_EPOT value
    if (ir->reds == 1)
    ir->nstcalcenergy = 1; 
    ...
    /* GJS - REDS - 2/25/2018 */
    if (file_version>=tpxv_ReplicaExchangeDynamicalScaling)
    {
	//here add code to read/write new data
	
        gmx_fio_do_int(fio,  ir->reds);	
        gmx_fio_do_int(fio,  ir->preprod);	
        gmx_fio_do_real(fio, ir->a11);	
        gmx_fio_do_real(fio, ir->b11);	
        gmx_fio_do_real(fio, ir->c11);	
