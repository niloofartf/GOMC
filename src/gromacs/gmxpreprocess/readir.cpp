...
#define CHECK(b) _low_check(b, err_buf, wi)
    ...
    int         i, j;
    real        dt_pcoupl;
    real        a11_b11_c11_LOWER_BOUND = -3001.0;
    real        a11_b11_c11_UPPER_BOUND = +20001.0;
...
/* GJS - REDS - 2/26/2018 
This is where I will check the values of 
a11, b11, c11 for whatever preconditions
they necessitate */

    if (ir->a11 < a11_b11_c11_LOWER_BOUND || ir->b11 < a11_b11_c11_LOWER_BOUND || ir->c11 < a11_b11_c11_LOWER_BOUND || ir->a11 > a11_b11_c11_UPPER_BOUND || ir->b11 > a11_b11_c11_UPPER_BOUND || ir->c11 > a11_b11_c11_UPPER_BOUND)
	{
		warning_error(wi, "a11/b11/c11 out of range.  -3000 < a11, b11, c11 < +20000");
	}

    if ( ir->reds == 0 && ir->preprod != 0 )
    {
        warning_error(wi, "Preproduction can't be true, unless reds is also true,  Check your mdp file");
    }

/* GJS - REDS - 2/26/2018 
This is where I checked the values of 
a11, b11, c11 for whatever preconditions
they necessitate */
            ...
            WriteMdpHeader writeMdpHeader, warninp_t wi)
{
    ...
    /* GJS - REDS - 2/25/18 */
    CCTYPE ("Dynamical Scaling Options");
    CTYPE ("Zeta optimization parameters");
    
    /* GJS - REDS - 3/16 */

    /* Default values are from original REDS code */
    //    RTYPE ("a11", ir->a11, SOME DEFAULT VALUE HERE);

    ITYPE ("reds", ir->reds,    0);
    ITYPE ("preprod", ir->preprod,    0);
    RTYPE ("a11", ir->a11, -3000.0);
    RTYPE ("b11", ir->b11, +20000.0);
    RTYPE ("c11", ir->c11, +10000.0);
