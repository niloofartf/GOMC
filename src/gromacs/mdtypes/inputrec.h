...
struct t_inputrec
{
    ...
    int         reds;                      /* Use REDS = nonzero, Use RE = 0, default 0                 */
    int         preprod;                      /* REDS is in preprod = nonzero, prod = 0, default 0      */
    real	    a11;		                 /* GJS - REDS - 2/25/2018 */
    real	    b11;		                 /* GJS - REDS - 2/25/2018 */
    real	    c11;		                 /* GJS - REDS - 2/25/2018 */
